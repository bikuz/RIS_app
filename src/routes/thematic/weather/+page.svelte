<script lang="ts">
	...
	let { currentTopic = 'weather', width = '100%', height = '400px' } = $props();
		...
		<div class="rounded-2xl border border-white/20 bg-white/100 p-6">
			<div class="mb-6 flex items-center justify-between">
				<div class="flex items-center space-x-3">
					<div class="rounded-lg bg-gradient-to-r from-yellow-500 to-orange-500 p-2">
						<Sun class="h-5 w-5 text-white" />
					</div>
					<h3
								...
								<div class="space-y-3">
									{#each information_layers as layer, index}
										<button
											...
											layer.title
												? 'border-yellow-300 bg-gradient-to-r from-yellow-50/90 to-orange-50/90 shadow-md'
...
{#if layoutState !== 'left-full'}
	<div class="fixed right-12 bottom-6 z-50 flex flex-col items-end">
				...
				{#each questions as questionItem, index}
					<button
						...
						questionItem.id
							...
							: 'border-slate-200/50 bg-white/50 hover:border-yellow-300 hover:bg-yellow-50/70 hover:shadow-sm'}"
					...
					>
						<div class="flex items-start space-x-2">
							<div class="mt-1 flex-shrink-0">
								...
								{:else}
									<div
										class="h-4 w-4 rounded-full border-2 border-slate-300 group-hover:border-yellow-400"
									></div>
								{/if}
							</div>
							<p
		...
		<button
			...
			class="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-yellow-500 to-orange-500 text-white shadow-xl transition-all duration-300 hover:scale-110 hover:shadow-2xl"
