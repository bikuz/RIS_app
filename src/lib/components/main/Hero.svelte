<script>
	import { Mountain, Globe, Database, TrendingUp } from '@lucide/svelte';
</script>
	...
	<div class="relative px-8 py-16 md:py-12">
		<div class=" text-center">
			<!-- <div class="flex justify-center mb-6">
				<Mountain class="h-16 w-16 text-white/90" />
			</div> -->
			<!-- <h1 class="text-4xl md:text-6xl font-bold mb-6">
				HKH at a glance
			</h1> -->
			<p class="text-xl md:text-2xl mb-8 text-white/90 max-w-6xl mx-auto">
